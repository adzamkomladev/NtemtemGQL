...
namespace NtemtemGQL.Migrations
{
    ...
    [Migration("20210921125019_AddAppointmentSeeder")]
    partial class AddAppointmentSeeder
    {
            ...
            modelBuilder.Entity("NtemtemGQL.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndTime = new DateTime(2021, 9, 30, 15, 30, 0, 0, DateTimeKind.Unspecified),
                            ExtraInfo = "This meeting is with Dr. Philip Kpone.",
                            OrganizationId = 1,
                            Reason = "This is an appointment to meet the head dematologist.",
                            StartTime = new DateTime(2021, 9, 30, 14, 30, 0, 0, DateTimeKind.Unspecified),
                            Status = "SCHEDULED",
                        ...
                        new
                        {
                            ...
                            ClientPhone = "0553995074",
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EndTime = new DateTime(2021, 9, 29, 15, 30, 0, 0, DateTimeKind.Unspecified),
                            ExtraInfo = "This meeting is with Dr. Anna Kpone.",
                            OrganizationId = 1,
                            Reason = "This is an appointment to meet the head opthalmologist.",
                            StartTime = new DateTime(2021, 9, 29, 14, 0, 0, 0, DateTimeKind.Unspecified),
                            Status = "SCHEDULED",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            ClientPhone = "0553995074",
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EndTime = new DateTime(2021, 9, 29, 10, 30, 0, 0, DateTimeKind.Unspecified),
                            ...
                            StartTime = new DateTime(2021, 9, 29, 9, 0, 0, 0, DateTimeKind.Unspecified),
                            Status = "SCHEDULED",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("NtemtemGQL.Models.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 9, 21, 12, 50, 18, 918, DateTimeKind.Utc).AddTicks(6903),
                            ...
                            Phone = "233553995074",
                            UpdatedAt = new DateTime(2021, 9, 21, 12, 50, 18, 918, DateTimeKind.Utc).AddTicks(7170)
                        },
                        new
                        {
                            Id = 2,
                            Address = "Arkesel, #1 Nii Oga Street",
                            CreatedAt = new DateTime(2021, 9, 21, 12, 50, 18, 918, DateTimeKind.Utc).AddTicks(7411),
                            Description = "Arkesel is a clouds communication company.",
                            Email = "adzamkomla@gmail.com",
                            Name = "Arkesel Company Limited",
                            Phone = "233202442452",
                            UpdatedAt = new DateTime(2021, 9, 21, 12, 50, 18, 918, DateTimeKind.Utc).AddTicks(7414)
                        });
                });
